...
class UpdateStudentProposalRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ddsdce_remark' => ['nullable', 'string', 'required_if:action,reject'],

            'needs_sponsorship_letter' => ['nullable', 'boolean'],
            'needs_invitation_letter' => ['nullable', 'boolean'],
            'needs_appointment_letter' => ['nullable', 'boolean'],
