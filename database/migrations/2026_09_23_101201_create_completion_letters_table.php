...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('completion_letters', function (Blueprint $table) {
            ...
            $table->foreignId('ia_academic_session_id')->constrained('academic_sessions')->restrictOnDelete();
            $table->date('ia_completion_date')->nullable();
            $table->enum('graduation_status', ['subject_to_endorsement', 'fulfilled']);
            $table->string('graduation_semester_text')->nullable();
