...
<body>
  ...
  <table class="ref-table">
    <tr>
      ...
      <td class="colon">:</td>
      <td>{{ $attendanceLetter->reference_no }}</td>
    </tr>
    <tr>
  ...
  <div class="title">SURAT PENGESAHAN</div>
  <div class="subtitle">KEPADA SESIAPA YANG BERKENAAN</div>
  ...
  <table class="detail-table">
    ...
    <tr>
      ...
      <td class="colon">:</td>
      <td>{{ collect([$attendanceLetter->student->nric_no, $attendanceLetter->student->passport_no])->filter()->implode(' / ') ?: '-' }}</td>
    </tr>
    <tr>
      <td class="detail-label">NO. MATRIK</td>
      <td class="colon">:</td>
      <td>{{ $attendanceLetter->student->matric_no }}</td>
    </tr>
    <tr>
      <td class="detail-label">PROGRAM</td>
      <td class="colon">:</td>
      <td>{{ strtoupper($attendanceLetter->student->program->name_bm ?? $attendanceLetter->student->program->name_en ?? '') }}</td>
    </tr>
  </table>

  @foreach (preg_split('/\n\s*\n/', trim($attendanceLetter->body_text)) as $paragraph)
    <p>{{ trim($paragraph) }}</p>
  @endforeach
